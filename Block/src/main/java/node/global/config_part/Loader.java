...
public class Loader {
     ...
     */
    Loader(GroupedMap groupedMap, Charset charset, boolean isUseVariable) {
     ...
     */
    private void load(InputStream settingStream) throws IOException {
    ...
    public void store(String absolutePath) {
        ...
        try {
            ...
            throw new IORuntimeException(e, "Store Config_ini to [{}] error!", absolutePath);
        } finally {
            IoUtil.close(writer);
        }
    }
